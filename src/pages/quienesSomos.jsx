    ...
    <>
      ...
      <div className="bg-[#fff5f5] text-[#2b2b2b] font-sans px-6 lg:px-32 py-16">
        ...
        >
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="text-3xl font-bold text-red-800 mb-4">{introduccion.titulo2}</h2>
            <p className="text-lg text-justify leading-relaxed">{introduccion.parrafo}</p>
          </div>
        </motion.div>
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 px-4 lg:px-35">
            {misionVisionData.map((item) => (
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-red-800 mb-2">{item.titulo}</h3>
      ...
      <section className="py-16 bg-[#fff5f5] text-center">
        ...
        <div className="flex justify-center items-center gap-6">
          <button onClick={handlePrevPrincipio} className="p-2 rounded-full border border-red-800 text-red-800 hover:bg-red-100 hover:scale-110 transition">
            <ChevronLeft />
          </button>
          <motion.div
          ...
          <button onClick={handleNextPrincipio} className="p-2 rounded-full border border-red-800 text-red-800 hover:bg-red-100 hover:scale-110 transition">
            <ChevronRight />
          </button>
        </div>
      </section>
      ...
      <section className="w-full py-16 bg-white text-center">
        ...
        <div className="flex justify-center items-center gap-6">
          <button onClick={handlePrevValor} className="p-2 rounded-full border border-red-800 text-red-800 hover:bg-red-100 hover:scale-110 transition">
            <ChevronLeft />
          </button>
          <motion.div
          ...
          <button onClick={handleNextValor} className="p-2 rounded-full border border-red-800 text-red-800 hover:bg-red-100 hover:scale-110 transition">
            <ChevronRight />
          </button>
        </div>
      </section>
      ...
      <section className="w-full py-16 bg-[#fdecea] text-red-800 text-center px-4">
        ...
        <div className="relative">
          <button onClick={handlePrevDirectivo} className="absolute left-0 top-1/2 -translate-y-1/2 p-2 rounded-full border border-white text-white hover:bg-white hover:text-red-700 transition">
            <ChevronLeft />
          </button>
          <div className="overflow-hidden">
            <motion.div
              key={currentDirectivoIndex}
              initial={{ opacity: 0, x: 100 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6 }}
            ...
            >
              {directivosData.map((persona, index) => (
                <div key={index} className="w-full md:w-1/2 lg:w-1/3 flex-shrink-0 px-3">
                  <div className="bg-white text-[#2b2b2b] rounded-2xl shadow-lg p-6 flex flex-col items-center hover:shadow-2xl hover:scale-105 transition">
                    <img src={persona.imagen} alt={persona.nombre} className="h-40 w-40 object-cover rounded-full mb-4 shadow-md" />
          ...
          <button onClick={handleNextDirectivo} className="absolute right-0 top-1/2 -translate-y-1/2 p-2 rounded-full border border-white text-white hover:bg-white hover:text-red-700 transition">
            <ChevronRight />
          </button>
        </div>
      </section>
