    ...
    <div className="relative m-3 py-40 px-4 sm:px-6 lg:px-8 text-white rounded-2xl overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 text-center z-10">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">
          Bienvenido a <span className="text-red-400">Cáritas</span> San Cristóbal
        </h1>
        <p className="text-xl md:text-2xl lg:text-3xl mb-8 max-w-4xl mx-auto leading-relaxed">
          Únete a nosotros para hacer la diferencia en nuestra comunidad
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <Link to="/quienes-somos" className="group bg-white/10 backdrop-blur-sm border-2 border-white/30 
        ...
        <p className="text-white/80 text-sm mt-6 max-w-2xl mx-auto">
          Tu donación ayuda a transformar vidas en las comunidades más necesitadas de Colombia
        </p>
      </div>
